...
const WarehouseManager = () => {
  ...
  const [newWarehouse, setNewWarehouse] = useState({ code: '', name: '', manager: '', status: 'نشط' });
  ...
  const handleAddWarehouse = async (e) => {
    ...
    try {
      ...
      setNewWarehouse({ code: '', name: '', manager: '', status: 'نشط' });
    } catch (error) {
  ...
  return (
    <div className="p-6 font-['Cairo'] text-right" dir="rtl">
      ...
      {/* Add Warehouse Form */}
      <form onSubmit={handleAddWarehouse} className="mb-8 bg-white p-6 rounded-lg shadow-md border-t-4 border-[#c0392b]">
