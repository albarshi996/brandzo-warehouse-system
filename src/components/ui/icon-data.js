/**
 * Inner SVG markup for the small set of icons used across the app.
 *
 * Each value is the *contents* of a `<svg>` element — paths/lines/rects only,
 * no outer `<svg>` wrapper, no namespace, no fill/stroke attributes (those
 * live on the wrapper rendered by `<Icon>`).
 *
 * Glyphs are extracted from Lucide (https://lucide.dev — ISC license).
 */
export const ICONS = {
  ...
  // Org chart / workflows: a parent node connected to two children.
  workflows:
    '<rect x="9" y="3" width="6" height="6" rx="1"/><rect x="3" y="15" width="6" height="6" rx="1"/><rect x="15" y="15" width="6" height="6" rx="1"/><path d="M12 9v3"/><path d="M6 15v-3h12v3"/>',
};
