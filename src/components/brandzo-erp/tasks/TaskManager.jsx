    ...
    <div className="space-y-6 text-right" dir="rtl">
      ...
      <div
        ...
        style={{
          ...
          backgroundColor: toast.isRed ? 'rgba(192, 57, 43, 0.95)' : 'rgba(26, 26, 46, 0.95)',
          color: 'white',
          border: toast.isRed ? '1px solid rgba(255,255,255,0.12)' : '1px solid rgba(232,184,48,0.25)',
          minWidth: '220px',
          textAlign: 'center',
        }}
      >
