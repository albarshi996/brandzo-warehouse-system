...
function DetailPanel({ stage, base }) {
  ...
  return (
    <div
      className={['mt-6 rounded-2xl border-2 bg-white p-5 sm:p-6 shadow-lg', c.border].join(' ')}
      dir="rtl"
    >
      <div className="flex items-start gap-3 mb-3">
        ...
        <div>
          <div className="font-bold text-brand-navy text-lg sm:text-xl">
            {stage.num} · {stage.titleAr}
          </div>
          <div className="text-xs sm:text-sm text-gray-500">{stage.titleEn}</div>
        </div>
      </div>
      <p className="text-sm text-gray-700 leading-relaxed mb-4">{stage.descAr}</p>
              ...
              <li key={f.file}>
                <a
                  ...
                  className={[
                    ...
                    'border-gray-200 hover:border-brand-red hover:bg-brand-red/5',
                    'text-sm text-gray-800 hover:text-brand-red font-medium',
                  ].join(' ')}
                >
                  <span>{f.titleAr}</span>
