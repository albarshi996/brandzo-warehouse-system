...
function DetailPanel({ node }) {
  ...
  return (
    <div
      className={['mt-6 rounded-2xl border-2 bg-white p-5 sm:p-6 shadow-lg', colors.border].join(
        ' '
      )}
      dir="rtl"
    >
      <div className="flex items-start gap-3 mb-3">
        ...
        <div>
          <div className="font-bold text-brand-navy text-lg sm:text-xl">{node.titleAr}</div>
          <div className="text-xs sm:text-sm text-gray-500">{node.titleEn}</div>
        </div>
      </div>
